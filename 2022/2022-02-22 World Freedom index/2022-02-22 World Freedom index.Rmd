...
```{r, fig.height = 10}
change |> 
  filter(country %in% c(standard_countries, cl_diff)) |> 
  ...
  ggplot() +
  geom_segment(aes(y = country, yend = country, x = CL_2010, xend = CL_2020, color = change_cl_factor), size = 3) +
