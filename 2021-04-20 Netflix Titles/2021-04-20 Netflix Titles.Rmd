...
```{r}
p <- p_over_time+ p_countries_2020 + plot_layout(widths = c(3.5, 1)) + plot_annotation(title = "Main countries of origin of Netflix titles", caption = "Data: Shivam Bansal | Visualization: @TannerFlorian") & theme(text=element_text(family=set_font))
p
